            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center h-16">
                ...
                <div className="flex items-center space-x-1">
                  <a href="/" className="text-sm text-slate-400 hover:text-white px-4 py-2 rounded-lg hover:bg-white/5 transition-all font-medium">
                    Verify
                  </a>
                  <a href="/admin/login" className="text-sm text-slate-400 hover:text-white px-4 py-2 rounded-lg hover:bg-white/5 transition-all font-medium">
                    Admin
                  </a>
                </div>
              </div>
